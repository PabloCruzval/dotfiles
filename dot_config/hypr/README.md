...
**Color Scheme**: Dynamically generated by Noctalia v5 from the active palette.
Defaults (fallback if Noctalia not yet loaded): active border `#88c0d0` (Nord frost), inactive `#3b4252` (Nord dark).
...
# Status bar, compositor integration
yay -S noctalia-git
